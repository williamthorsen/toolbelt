...
describe('ADOPTED_EXPORTS', () => {
  // Fails when the tier gains a callable export that nothing added to the list adoption is counted against.
  ...
  it('names nothing the tier does not export', () => {
    const exported = new Set(Object.keys(candidateExports));
